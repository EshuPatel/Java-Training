...
public class ShoppingDemo {
    public static void main(String[] args) {
        ...
        ShoppingCart cart1 = new ShoppingCart("Anita");

        // Adding Products
        cart1.addProduct(new Laptop("Lenovo XPS 15", 85000));
        cart1.addProduct(new Mobile("Samsung 15", 120000));
