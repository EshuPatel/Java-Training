...
/*
 * Airline Ticket Booking with Composition Example
 * 
 *  Composition (Strong Has-A relationship):
 * 	Booking has Payment → Payment cannot exist without Booking.
 *  Lifecycle dependency: When Booking is created → Payment is created.
 *  If Booking is deleted → Payment is gone.
 *  Multiple Bookings managed using an array.
 *  Search by Booking ID included.
 */

public class AirlineComposnDemo {
